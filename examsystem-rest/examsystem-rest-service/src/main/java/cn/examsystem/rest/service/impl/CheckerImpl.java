...
public class CheckerImpl implements CheckerService{
    ...
    public ResultInfo checkQuestion(String[] questionIds,String questionType) throws Exception {
        ...
        for(String questionId:questionIds){
            ...
            testpaperQuestionRelationCriteria.andQuestionIdEqualTo(questionId);
            ...
            if(StringUtils.equals(DICTINFO_SINGLECHOICEQUESTION_TYPE_CODE,questionType)){//单选题
                SingleChoiceQuestion singleChoiceQuestion = singleChoiceQuestionMapper.selectByPrimaryKey(questionId);
                ...
                TrueOrFalseQuestion trueOrFalseQuestion = trueOrFalseQuestionMapper.selectByPrimaryKey(questionId);
                ...
                //审核题目
                fillInBlankQuestion.setIsChecked(true);
                fillInBlankQuestion.setUpdatedTime(new Date());
