...
<body class="gray-bg">
                            ...
                            <div class="form-group " >
                                ...
                                <div class=" col-sm-6">
                                    <select data-placeholder="选择答案..." class="form-control chosen-select " style="width:270px;" tabindex="2" id="answer_add"   name="answer">
                                        <option value="true" hassubinfo="true">√</option>
                                        <option value="false" hassubinfo="true">×</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group " >
    ...
    <script type="text/javascript">
        ...
        function openUpdateQuestionModal(){
            ...
            if(answer){
                $("#answer_update").val("true").trigger("chosen:updated");
            }else{
                $("#answer_update").val("false").trigger("chosen:updated");
            }
        ...
        window.operateEvents={
            "click #questionDetails":function (e,value,row,index) {
                ...
                $.ajax({
                    type: "GET",
                    url: "/v1/trueOrFalseQuestion/"+row.id,
                    data: null,
                    success: function(data){
                        if(data.status == 200){
